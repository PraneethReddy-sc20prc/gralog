...
@AlgorithmDescription(
        name = "KAHIP - Edge Partitioning",
        text = "This is the multilevel graph partitioning program.",
        url = "https://kahip.github.io"
)
public class EdgePartitioning extends Algorithm {

    private static final List<String> requiredParameters = Arrays.asList("k","seed", "preconfiguration", "imbalance");
    ...
    public Object run(Structure s, AlgorithmParameters params, Set<Object> selection, ProgressHandler onprogress) throws Exception {
        ...
        command.add("./edge_partitioning KaHIP_results/myGraph.graph ");
