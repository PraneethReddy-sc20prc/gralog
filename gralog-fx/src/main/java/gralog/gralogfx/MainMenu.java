...
public class MainMenu {
    ...
    private Menu menuKaHIPAlgorithms;
...
//            createMenuItem("Load spec'd program", handlers.onLoadPluginFromSpecifiedFilepath),
    ...
    private Menu createAlgorithmMenu() {
        ...
        menuKaHIPAlgorithms = new Menu("KaHIP Algorithms");
    ...
    private void updateAlgorithms() {
        ...
        menuKaHIPAlgorithms.getItems().clear();
        ...
        for (String str : AlgorithmManager.getAlgorithms(currentStructure.getClass())) {
            if(str.contains("KAHIP"))
                menuKaHIPAlgorithms.getItems().add(createMenuItem(str, handlers.onRunAlgorithm));
            else
                menuAlgorithms.getItems().add(createMenuItem(str, handlers.onRunAlgorithm));
        }
        menuAlgorithms.getItems().add(new SeparatorMenuItem());
        menuAlgorithms.getItems().add(menuKaHIPAlgorithms);
    }
